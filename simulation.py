...
shuttle_utilizations = [x / (run_time/2) for x in shuttle_util]
lift1_utilizations = [x / (run_time/2) for x in lift1_util]
...
for a in range(len(lift1_utilizations)):
    print("Lift 1:%s utilization is %4.2f" % (a + 1, lift1_utilizations[a]))
